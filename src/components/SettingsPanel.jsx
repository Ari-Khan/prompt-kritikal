...
export default function SettingsPanel({
    ...
    const updatePerf = useCallback(
        ...
        [onPerformanceChange, performanceSettings]
    );
    ...
    return (
        ...
        >
            <button className="settings-toggle" onClick={toggleOpen}>
                ...
                <div className="settings-body dropup">
                    ...
                    >
                        <select
                            ...
                            onChange={(e) =>
                                updatePerf("antialias", e.target.value === "on")
                            }
                        >
                    ...
                    >
                        <select
                            value={
                                performanceSettings.powerPreference || "default"
                            }
                            onChange={(e) =>
                                updatePerf("powerPreference", e.target.value)
                            }
                        >
                    ...
                    <SettingRow label="Map" tip="Change Earth surface texture.">
                        <select
                            value={texture}
